...
__cvsversion__ = "$Revision: 1.8 $"
__date__       = "$Date: 2006/04/19 15:36:17 $"
__copyright__  = "Copyright (c) 2006 Aaron Straup Cope. Perl Artistic License."

from erdfg.constants.xmlns import NS_MAP
from erdfg.generator.base import base
import textwrap
import codecs

class erdfggenerator (base) :
    ...
    def write_content (self, entry, fh) :
        ...
        for label in ('title', 'link', 'content', 'author', 'date') :
            if entry.has_key(label) and not entry[label]==None :
